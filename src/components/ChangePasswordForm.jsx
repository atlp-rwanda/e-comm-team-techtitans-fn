...
const ChangePasswordForm = () => {
  ...
  const handleChangePassword = async (event) => {
    ...
    if (!old_password) {
      ...
      setErrorMessage(
        'Your password must contain at least 1 uppercase, 1 lowercase, 1 digit, and one special character.',
      );
      return;
      ...
      try {
        ...
        const resultAction = await dispatch(
          changePassword({ old_password, new_password, confirm_password, id }),
        );
      ...
      <div className="changepassword-section" id={theme}>
        <div className="card-form">
          <div className="form-title">
            <span>
              <span className="word-update">Update</span>{' '}
              <span className="your-password-text">Your Password</span>
            </span>
          </div>
